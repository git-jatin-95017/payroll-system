...
class HousingRentalIndicePriceController extends Controller
{
   /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = HousingRentalIndicesPrice::query();
        ...
        return view('admin.housing-rental-indices-prices.index');
    }
    ...
    {
        $code = HousingRentalIndicesPrice::find($id);
        $code->delete();
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                HousingRentalIndicesPrice::whereIn('id', $request->get('ids'))->delete();
