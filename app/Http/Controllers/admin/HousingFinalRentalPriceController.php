...
class HousingFinalRentalPriceController extends Controller
{
   /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = HousingFinalRentalPrice::query();
        ...
        return view('admin.housing-final-rental-prices.index');
    }
    ...
    {
        $code = HousingFinalRentalPrice::find($id);
        $code->delete();
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                HousingFinalRentalPrice::whereIn('id', $request->get('ids'))->delete();
