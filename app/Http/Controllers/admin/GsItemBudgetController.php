...
class GsItemBudgetController extends Controller
{
     /**
    ...
    public function index(Builder $builder)
    {
        ...
        return view('admin.gs-item-budgets.index');
    }
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                GsItemBudget::whereIn('id', $request->get('ids'))->delete();
