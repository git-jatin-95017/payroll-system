...
class HousingPropertyTaxIndicePriceController extends Controller
{
    /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = HousingPropertyTaxIndicesPrice::query();
        ...
        return view('admin.housing-property-tax-indices-prices.index');
    }
    ...
    {
        $code = HousingPropertyTaxIndicesPrice::find($id);
        $code->delete();
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                HousingPropertyTaxIndicesPrice::whereIn('id', $request->get('ids'))->delete();
