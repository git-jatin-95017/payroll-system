...
class GSCItemPriceCityController extends Controller
{
    /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = GsComponentItemPricesCity::query();
        ...
        return view('admin.gsc-itemprice-cities.index');
    }
    ...
    {
        $code = GsComponentItemPricesCity::find($id);
        $code->delete();
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                GsComponentItemPricesCity::whereIn('id', $request->get('ids'))->delete();
