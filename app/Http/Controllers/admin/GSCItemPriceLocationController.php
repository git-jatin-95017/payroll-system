...
class GSCItemPriceLocationController extends Controller
{
    /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = GsComponentItemPricesLocation::query();
        ...
        return view('admin.gsc-itemprice-locations.index');
    }
    ...
    {
        $code = GsComponentItemPricesLocation::find($id);
        $code->delete();
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                GsComponentItemPricesLocation::whereIn('id', $request->get('ids'))->delete();
