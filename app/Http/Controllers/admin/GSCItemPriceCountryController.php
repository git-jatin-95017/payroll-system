...
class GSCItemPriceCountryController extends Controller
{
     /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = GsComponentItemPricesCountry::query();
        ...
        return view('admin.gsc-itemprice-countries.index');
    }
    ...
    {
        $code = GsComponentItemPricesCountry::find($id);
        $code->delete();
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                GsComponentItemPricesCountry::whereIn('id', $request->get('ids'))->delete();
