...
class GSFinalItemPriceController extends Controller
{
     /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = GsFinalItemPrice::query();
        ...
        return view('admin.gs-final-item-prices.index');
    }
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                GsFinalItemPrice::whereIn('id', $request->get('ids'))->delete();
