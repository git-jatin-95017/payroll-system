...
class GSCItemPriceAdjustCityController extends Controller
{
    /**
    ...
    {
        if (request()->ajax()) {
            $usersQuery = GsComponentItemPricesAdjustedCity::query();
        ...
        return view('admin.gsc-itemprice-adjusted-cities.index');
    }
    ...
    {
        $code = GsComponentItemPricesAdjustedCity::find($id);
        $code->delete();
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                GsComponentItemPricesAdjustedCity::whereIn('id', $request->get('ids'))->delete();
