...
class GSCityBudgetController extends Controller
{
    ...
    public function index(Builder $builder)
    {
        ...
        return view('admin.gs-city-budgets.index');
    }
    ...
    {  
        if (request()->ajax()) {
            ...
            if (request()->is_delete_request) {
                ...
                GsCityBudget::whereIn('id', $request->get('ids'))->delete();
