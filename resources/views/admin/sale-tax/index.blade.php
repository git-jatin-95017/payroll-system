						...
						<div class="card-body">
							<div class="row">
							    ...
							    <div class="col text-right">
							      <button type="text" id="delete-all" data-remote="{{ route('sale-tax.multi-delete') }}" class="btn btn-danger">Delete All</button>
							    </div>
							</div>
							<br>
		...
		$(document).ready( function () {
		   ...
		   $('#delete_record').click(function(){
		      ...
		      if(delete_ids.length > 0){
		         ...
		         if (confirmdelete == true) {
		            $.ajax({
		               url: "{{ route('sale-tax.multi-delete') }}",
		               type: 'POST',
