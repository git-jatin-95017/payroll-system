...
@section('content')
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">ERD - GS ITem Price Countries</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">GS ITem Price Countries</li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">ERD - GS ITem Price Countries</h3>
						</div>
						<div class="card-body">
							<div class="row">
							    <div class="col">
							    ...
							    <div class="col text-right">
							      <button type="text" id="delete-all" data-remote="{{ route('gsc-itemprice-countries.multi-delete') }}" class="btn btn-danger">Delete All</button>
							    </div>
							</div>
							<br>							
		...
		$(document).ready( function () {
			...
			// }, 1000);
		  	...
		  	var table = $('#dataTableBuilder').DataTable({
					...
					scrollY: "400px",
					ajax: {
						url: "{{ route('gsc-itemprice-countries.index') }}",
					  	type: 'GET',
					  	data: function (d) {
		   ...
		   $('#delete_record').click(function(){
		      ...
		      if(delete_ids.length > 0){
		         ...
		         if (confirmdelete == true) {
		            $.ajax({
		               url: "{{ route('gsc-itemprice-countries.multi-delete') }}",
		               type: 'POST',
