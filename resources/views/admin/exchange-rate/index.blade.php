				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Exchange Rates Data</h3>
						</div>
						<div class="card-body">
							<div class="row">
							    <div class="col">
							    ...
							    <div class="col text-right">
							      <button type="text" id="delete-all" data-remote="{{ route('exchange-rates.multi-delete') }}" class="btn btn-danger">Delete All</button>
							    </div>
							</div>
							<br>
		...
		$(document).ready( function () {
			...
			// }, 1000);
		  	...
		  	var table = $('#dataTableBuilder').DataTable({
					...
					scrollY: "400px",
					ajax: {
						url: "{{ route('exchange-rates.index') }}",
					  	type: 'GET',
					  	data: function (d) {
		   ...
		   $('#delete_record').click(function(){
		      ...
		      if(delete_ids.length > 0){
		         ...
		         if (confirmdelete == true) {
		            $.ajax({
		               url: "{{ route('exchange-rates.multi-delete') }}",
		               type: 'POST',
