						...
						<div class="card-body">
							<div class="row">
							    ...
							    <div class="col text-right">
							      <button type="text" id="delete-all" data-remote="{{ route('super-market.multi-delete') }}" class="btn btn-danger">Delete All</button>
							    </div>
							</div>
							<br>
		...
		$(document).ready( function () {
			...
			// }, 1000);
		  	...
		  	var table = $('#dataTableBuilder').DataTable({
					...
					columns: [
						...
						{data:'number_of_units', name: 'number_of_units'},									
		   ...
		   $('#delete_record').click(function(){
		      ...
		      if(delete_ids.length > 0){
		         ...
		         if (confirmdelete == true) {
		            $.ajax({
		               url: "{{ route('super-market.multi-delete') }}",
		               type: 'POST',
