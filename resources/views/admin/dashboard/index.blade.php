...
<section class="dashboard-top-bg p-5">
    ...
    <div class="d-flex gap-5 mt-4 justify-content-center widget-container-main">
        ...
        <div class="widget-container">
            <a href="{{ route('settings.create', auth()->user()->id) }}" class="d-flex flex-column align-items-center">
                <div class="widget-icon d-flex justify-content-center align-items-center">
        ...
        <div class="widget-container">
            <a href="{{ route('edit-my-profile.edit', auth()->user()->id) }}" class="d-flex flex-column align-items-center">
                <div class="widget-icon d-flex justify-content-center align-items-center">
                    <x-bxs-user class="w-24 h-24"/>
                </div>
                <p>Profile</p>
