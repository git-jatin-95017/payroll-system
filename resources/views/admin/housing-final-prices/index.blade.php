						...
						<div class="card-body">
							<div class="row">
							    ...
							    <div class="col text-right">
							      <button type="text" id="delete-all" data-remote="{{ route('housing-final-prices.multi-delete') }}" class="btn btn-danger">Delete All</button>
							    </div>
							</div>
							<br>							
		...
		$(document).ready( function () {
			...
			// }, 1000);
		  	...
		  	var table = $('#dataTableBuilder').DataTable({
					...
					scrollY: "400px",
					ajax: {
						url: "{{ route('housing-final-prices.index') }}",
					  	type: 'GET',
					  	data: function (d) {
		   ...
		   $('#delete_record').click(function(){
		      ...
		      if(delete_ids.length > 0){
		         ...
		         if (confirmdelete == true) {
		            $.ajax({
		               url: "{{ route('housing-final-prices.multi-delete') }}",
		               type: 'POST',
