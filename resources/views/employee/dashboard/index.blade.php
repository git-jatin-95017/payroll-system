...
<section class="dashboard-top-bg p-5">
    ...
    <div class="d-flex gap-5 justify-content-center widget-container-main">
        ...
        <div class="widget-container">
            <a href="{{ route('my.payslip') }}" class="d-flex flex-column align-items-center">
                <div class="widget-icon d-flex justify-content-center align-items-center">
        ...
        <div class="widget-container">
            <a href="{{ route('holidays.index') }}" class="d-flex flex-column align-items-center">
                <div class="widget-icon d-flex justify-content-center align-items-center">
        ...
        <div class="row">
            ...
            <div class="col-8 mb-4">
                <div class="db-container p-4 shadow-sm bg-white h-100">
                    ...
                    <canvas id="payrollChart"  style="max-width: 100%;"></canvas>
        ...
        <div class="row">
            <div class="col-4 mb-5">
                <div class="db-container p-4 shadow-sm bg-white">
                    ...
                    <div class="db-card">
                        <a href="{{ route('emp-my-profile.edit', auth()->user()->id) }}" class="d-block mb-4">
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <div>
                                    <h3>Profile</h3>
                                    <span>Employee profile and administration</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('my-leaves.index') }}" class="d-block">
                            <div class="d-flex gap-3 align-items-center">
                                <div class="notice-icon shadow-sm">
        ...
        if (calendarEl) {
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: function (fetchInfo, successCallback, failureCallback) {
                    $.ajax({
                        url: '/employee/emp-fetch-calendar-data',
                        method: 'GET',
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadPayrollData() {
            fetch('/employee/emp-recent-payroll')
