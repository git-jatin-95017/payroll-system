      ...
      <form class="form-horizontal" method="POST" action="{{ route('my-profile.update', auth()->user()->id) }}">
        ...
        <div id="dynamicRowsContainer">
          <div class="row">
            <div class="col-6 mb-3">
              <div class="form-group">
                <label for="admin_name" class="db-label">Admin Name</label>
                <div class="col-md-12">
            ...
            <div class="col-6 mb-3">
              <div class="form-group">
                <label for="admin_email" class="db-label">Admin Email address</label>
            ...
            <div class="col-6 mb-3">
              <div class="form-group">
                <label for="admin_password" class="db-label">Admin Login Password</label>
            ...
            <div class="col-6 mb-3">
              <div class="form-group">
                <label for="admin_password_confirmation" class="db-label">Confirm Password</label>
                <input id="admin_password_confirmation" type="password" class="form-control db-custom-input"
        ...
        <div class="col-md-12 text-end">
          <button type="button" id="addNewRow" class="btn btn-primary submit-btn">Add New</button>
          <button type="submit" class="btn btn-primary submit-btn">Submit</button>
        </div>
      </form>
    </div>
    ...
    <div class="max-w-md mx-auto">
      ...
      <form class="form-horizontal" method="POST" action="{{ route('my-profile.update', auth()->user()->id) }}">
        ...
        <div class="row">
          <div class="col-6 mb-3">
            <div class="form-group">
              <label for="old_password" class="db-label">Current Password</label>
              <div class="col-md-12">
                <input id="old_password" type="password"
                  class="form-control db-custom-input {{ $errors->has('old_password') ? ' is-invalid' : '' }}"
                  name="old_password">
          ...
          <div class="col-6 mb-3">
            <div class="form-group">
              <label for="password_confirmation" class="db-label">Confirm Password</label>
