        ...
        <div class="bg-white p-4 rounded mb-4">
           ...
           <div class="row mb-3">
                <div class="col-6">
                    <div class="">
                        <div class="mr-3">
                            ...
                            <input type="text" class="custom-input-top" value="{{ucwords(auth()->user()->companyProfile->company_name)}}">
                        </div>                        
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex">
                        ...
                        <div>
                            <label class="custom-label-top mr-2 mb-0">REG 45454</label>
                            <input type="text" class="custom-input-top">
                        </div>
                    </div>
                </div>  
                <div class="col-6">
                    <div class="d-flex">
                        <div class="mr-3">
                            <label class="custom-label-top mr-2 mb-0">PO BOX:</label>
                            <input type="text" class="custom-input-top" value="">
                        </div>
                        <div>
                            <label class="custom-label-top mr-2 mb-0">Address:</label>
                            <input type="text" class="custom-input-top" value="{{ucwords(auth()->user()->companyProfile->address)}}">
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex">
                        <div class="mr-3">
                            <label class="custom-label-top mr-2 mb-0">For Month of:</label>
                            <input type="text" class="custom-input-top" value="{{date('F Y')}}">
                        </div>
                        <div>
                            <label class="custom-label-top mr-2 mb-0"></label>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 4%;">
                        <span class="d-block">Sex</span>
                    </td>
                    <td style="width: 35%;">
                        <table class="inner-table">
                            <tbody>
                                <tr>
                                    <td style="width: 18%;"class="table-left-none">Week endingE</td>
                                    <td style="width: 18%;">Week ending</td>
                                    <td style="width: 18%;">Week ending</td>
                                    <td style="width: 18%;">Week ending</td>
                                    <td style="width: 18%;">Week ending</td>
                                </tr>
                                <tr>
                                    <td style="width: 18%;"class="table-left-none">Sat 04 Nov</td>
                                    <td style="width: 18%;">Sat 04 Nov</td>
                                    <td style="width: 18%;">Sat 04 Nov</td>
                                    <td style="width: 18%;">Sat 04 Nov</td>
                                    <td  class="table-right-none">Sat 04 Nov</td>
                                </tr>
                                <tr>
                    ...
                    <td style="width: 7%;">
                        <span class="d-block">TOTAL</span>
                        <span class="d-block">(Applicable%)</span>
                        <span class="d-block">CONTRIBUTIONS</span>
                    </td>
                    <td style="width: 7%;">
                ...
                <tr>
                    <td></td>
                    <td colspan="8" style="background-color: #777; color: #fff;"></td>
                </tr>
                <tr>
                    <td style="width: 7%;">34532</td>
                    <td style="width: 14%;">
...
<div class="text-center">
    <a href="#" class="btn btn-primary bnt-sm"  onclick="printDivContent()">PRINT</a>
</div>
@endsection
@push('page_scripts')
	<script>
    ...
    <script>
      function printDivContent() {
        ...
        // newWindow.document.write('<html><head><title>MEDICAL</title></head><body>');
