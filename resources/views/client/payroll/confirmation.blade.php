    ...
    <?php
        ...
        if ($pay_type == 'hourly' || $pay_type == 'weekly') {
            if ($dob <= 60) {
                ...
                $medical_benefitsT = ($grossT * 2.5) / 100;
            } else if ($dob > 70 ) {
                $medical_benefitsT = 0;
            }

            $social_securityT = ( $grossT>1500 ? ((1500*6.5) / 100) : ($grossT*6.5) / 100 );  
            $social_securityT_employer = ( $grossT>1500 ? ((1500*8.5) / 100) : ($grossT*8.5) / 100 );  
            $education_lveyT = ($grossT<=125?0:($grossT>1154?( ((1154-125)*2.5) / 100)+( (($grossT-1154)*5) / 100 ):( (($grossT-125)*2.5) /100)));
            ...
            if ($days <= 7) {
                $social_securityT = ( $grossT>3000 ? ((3000*6.5) / 100) : ($grossT*6.5) / 100 ); 
                $social_securityT_employer = ( $grossT>3000 ? ((3000*8.5) / 100) : ($grossT*8.5) / 100 ); 
            } else {
                $social_securityT = ( $grossT>3000 ? ((3000*6.5) / 100) : ($grossT*6.5) / 100 ); 
                $social_securityT_employer = ( $grossT>3000 ? ((3000*8.5) / 100) : ($grossT*8.5) / 100 ); 
            }
            $education_lveyT = ($grossT<=250?0:($grossT>2308?(((2308-250)*2.5)/100)+((($grossT-2308)*5)/100):((($grossT-250)*2.5)/100)));
            $mbse_deductions = $medical_benefitsT + $social_securityT + $education_lveyT;
            $net_pay = $grossT - $mbse_deductions;
            if ($days <= 7) {
            } else {
            ...
            $social_securityT = ( $grossT>3000 ? ((3000*6.5) / 100) : ($grossT*6.5) / 100 ); 
            $social_securityT_employer = ( $grossT>3000 ? ((3000*8.5) / 100) : ($grossT*8.5) / 100 ); 
            $education_lveyT = ($grossT<=125?0:($grossT>2500?(((2500-270.84)*2.5)/100)+((($grossT-2500)*5)/100):((($grossT-270.84)*2.5)/100)));
            $mbse_deductions = $medical_benefitsT + $social_securityT + $education_lveyT;
            $net_pay = $grossT - $mbse_deductions;
            ...
            $social_securityT = ( $grossT>6500 ? ((6500*6.5) / 100) : ($grossT*6.5) / 100 ); 
            $social_securityT_employer = ( $grossT>6500 ? ((6500*8.5) / 100) : ($grossT*8.5) / 100 ); 
            $education_lveyT = ($grossT<=125?0:($grossT>5000?(((5000-541.67)*2.5)/100)+((($grossT-5000)*5)/100):((($grossT-541.67)*2.5)/100)));
            $mbse_deductions = $medical_benefitsT + $social_securityT + $education_lveyT;
            $net_pay = $grossT - $mbse_deductions;
        }
                                            ...
                                            <?php
                                                ...
                                                if ($pay_type == 'hourly' || $pay_type == 'weekly') {
                                                    if ($dob <= 60) {
                                                        ...
                                                        $medical_benefits1 = ($gross1 * 2.5) / 100;
                                                    } else if ($dob > 70 ) {
                                                        $medical_benefits1 = 0;
                                                    }

                                                    $social_security1 = ( $gross1>1500 ? ((1500*6.5) / 100) : ($gross1*6.5) / 100 );  
                                                    $social_security_employer1 = ( $gross1>1500 ? ((1500*8.5) / 100) : ($gross1*8.5) / 100 );  
                                                    $education_lvey1 = ($gross1<=125?0:($gross1>1154?( ((1154-125)*2.5) / 100)+( (($gross1-1154)*5) / 100 ):( (($gross1-125)*2.5) /100)));
                                                    ...
                                                    if ($days <= 7) {
                                                        $social_security1 = ( $gross1>3000 ? ((3000*6.5) / 100) : ($gross1*6.5) / 100 ); 
                                                        $social_security_employer1 = ( $gross1>3000 ? ((3000*8.5) / 100) : ($gross1*8.5) / 100 ); 
                                                    } else {
                                                        $social_security1 = ( $gross1>3000 ? ((3000*6.5) / 100) : ($gross1*6.5) / 100 ); 
                                                         $social_security_employer1 = ( $gross1>3000 ? ((3000*8.5) / 100) : ($gross1*8.5) / 100 ); 
                                                    }
                                                    $education_lvey1 = ($gross1<=250?0:($gross1>2308?(((2308-250)*2.5)/100)+((($gross1-2308)*5)/100):((($gross1-250)*2.5)/100)));
                                                    // $mbse_deductions = $medical_benefits1 + $social_security1 + $education_lvey1;
                                                    ...
                                                    $social_security1 = ( $gross1>3000 ? ((3000*6.5) / 100) : ($gross1*6.5) / 100 ); 
                                                    $social_security_employer1 = ( $gross1>3000 ? ((3000*8.5) / 100) : ($gross1*8.5) / 100 ); 
                                                    $education_lvey1 = ($gross1<=125?0:($gross1>2500?(((2500-270.84)*2.5)/100)+((($gross1-2500)*5)/100):((($gross1-270.84)*2.5)/100)));
                                                    // $mbse_deductions = $medical_benefits1 + $social_security1 + $education_lvey1;
                                                } else if ($pay_type == 'monthly') {
                                                    if ($dob <= 60) {
                                                        $medical_benefits1 = ($gross1 * 3.5) / 100;
                                                    ...
                                                    $social_security1 = ( $gross1>6500 ? ((6500*6.5) / 100) : ($gross1*6.5) / 100 ); 
                                                    $social_security_employer1 = ( $gross1>6500 ? ((6500*8.5) / 100) : ($gross1*8.5) / 100 ); 
                                                    $education_lvey1 = ($gross1<=125?0:($gross1>5000?(((5000-541.67)*2.5)/100)+((($gross1-5000)*5)/100):((($gross1-541.67)*2.5)/100)));
                                                    // $mbse_deductions = $medical_benefits1 + $social_security1 + $education_lvey1;
                                                }
