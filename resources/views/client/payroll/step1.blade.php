							...
							<div class="card-body">
								<table class="table table-bordered table-hover">
									<thead>
									    <tr>
									      <!-- <th scope="col">#</th> -->
									      <th scope="col"><b>Employees (3)</b></th>
									      <th scope="col"><b>Hours Worked (hrs.)</b></th>
									      <th scope="col"><b>Additional Earnings</b></th>
									      <th scope="col"><b>Gross Pay</b></th>
									    </tr>
									</thead>
									<tbody>
									    ...
									    <tr>									      
									      	...
									      	<td class="col-sm-5">
									      		...
									      		<input type="number" name="input[{{$employee->id}}][working_hrs]" min="0" value="{{ $totalHours }}" class="form-control">
									      	</td>
									      	<td class="col-sm-2">
									      		<?php
									      		...
									      		?>									      				
											      		<small class="font-bold">{{$v->payhead->name}} 										      	
											      			...
											      			<input type="number" value="{{$v->amount}}" name="input[{{$employee->id}}][earnings][{{$k }}][amount]" min="0" class="form-control">
											      		</small>
											      		<br>												      	
									      		<?php
									      				}
									      		...
									      		?>
									      				@foreach($employee->payheads as $key =>$value)
												      		<small class="font-bold">{{$value->payhead->name}} 										      	
												      			...
												      			<input type="number" name="input[{{$employee->id}}][earnings][{{$key }}][amount]" min="0" class="form-control">
												      		</small><br>
												      	@endforeach
									      		<?php
									      			}
									      ...
									      <td class="col-sm-2">
									      	$3680.589<br/><br>
									      	<small class="font-bold">Reimbursement
									      		<input type="number" name="input[{{$employee->id}}][reimbursement]" value="{{$reimbursement}}" min="0" class="form-control"></small><br/><br>
									      </td>
									    </tr>								
									    @endforeach	    
									</tbody>
