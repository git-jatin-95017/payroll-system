            ...
            <div class="page-heading d-flex justify-content-between align-items-center gap-3 mb-4">
                ...
                <div>
                    <select class="form-select" name="reports" id="reportSelect">
                        <option value="{{ route('payroll.reports.employee-earnings', request()->query()) }}">Reports</option>
                        <option value="{{ route('payroll.reports.employee-earnings', request()->query()) }}" {{ request()->routeIs('payroll.reports.employee-earnings') ? 'selected' : '' }}>Employee Earnings</option>
                        <option value="">Employee Gross Earnings</option>
                        <option value="{{ route('payroll.reports.employer-payments', request()->query()) }}" {{ request()->routeIs('payroll.reports.employer-payments') ? 'selected' : '' }}>Employer Earnings</option>
