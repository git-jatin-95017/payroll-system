				...
				<div class="col-sm-12">
					<div class="max-w-md max-auto">
						<div class="sub-text-heading pb-4">
							<h3 class="mb-1">Leave Information</h3>
							<p>Edit your leave information here</p>
						</div>
							...
							<div class="row">
								<div class="col-8 mb-3">
									<div class="form-group">
										...
										<input id="leave_subject" type="text" class="form-control db-custom-input {{ $errors->has('leave_subject') ? ' is-invalid' : '' }}" name="leave_subject" value="{{ $leave->leave_subject }}">
							...
							<div class="row">
								<div class="col-8 mb-3">
									<div class="form-group">
										...
										<select class="form-control db-custom-input custom-select assignleave" name="typeid" id="leavetype">
								...
								<div class="col-md-12">
									...
									<div class="span pull-right">
										<button class="btn btn-info fetchLeaveTotal" data-empid="{{$empId}}" class="db-label">Fetch Total Leave</button>
									</div>
									<br>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-8 mb-3">
									<div class="form-group">
										...
										<div class="form-check form-check-inline custom-radio-btn">
											<input name="type" type="radio" id="radio_2" data-value="Full" class="form-check-input type" value="Full Day" @if($leave->leave_type =='Full Day') checked="" @endif>
											<label class="form-check-label" for="inlineRadio2">Full Day</label>
										</div>
										<div class="form-check form-check-inline custom-radio-btn">
											<input name="type" type="radio" class="form-check-input with-gap duration" id="radio_3" data-value="More" value="More than One day" @if($leave->leave_type =='More than One day') checked="" @endif>
							...
							<div class="row">
								<div class="col-8 mb-3">
									<div class="form-group">
	                                	...
	                                	<input type="date" name="startdate" class="form-control db-custom-input" id="recipient-name1" value="{{$leave->start_date}}">
							...
							<div class="row" id="enddate">
								<div class="col-8 mb-3">
									<div class="form-group">
										...
										<input type="date" name="enddate" class="form-control db-custom-input" id="recipient-name1" value="{{$leave->end_date}}">
							...
							<div class="row" id="hourAmount">
								<div class="col-8 mb-3">
									<div class="form-group">
										...
										<input id="hourAmount" type="text" id="hourAmountVal" class="form-control db-custom-input {{ $errors->has('hourAmount') ? ' is-invalid' : '' }}" name="hourAmount" value="{{ $leave->leave_duration }}">
							...
							<div class="row">
								<div class="col-8 mb-3">
									<div class="form-group">
										...
										<textarea name="leave_message" id="leave_message" class="form-control db-custom-input {{ $errors->has('leave_message') ? ' is-invalid' : '' }}" rows="4">{{ $leave->leave_message }}</textarea>
