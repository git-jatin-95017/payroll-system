			...
			<div class="row">            	
				<div class="col-sm-6">
					<div class="card">
						...
						<form class="form-horizontal" id="leaveapply" method="POST" action="{{ route('edit-leave.save', $leave->id) }}">
							@csrf
							{{ method_field('PUT') }}
							<div class="card-body">								
								<div class="form-group">
									...
									<div class="col-md-12">
										<input id="leave_subject" type="text" class="form-control {{ $errors->has('leave_subject') ? ' is-invalid' : '' }}" name="leave_subject" value="{{ $leave->leave_subject }}">
								...
								<div class="form-group">
									<div class="col-md-12">
		                                ...
		                                <select class="form-control custom-select assignleave" name="typeid" id="leavetype">
		                                    ...
		                                    <option value="<?php echo $value->id ?>" @if($value->id == $leave->leaveType->id) selected @endif><?php echo $value->name ?></option>
	                            ...
	                            <div class="form-group">
	                            	<div class="col-md-12">
		                                ...
		                                <div class="d-flex">
											<div class="mr-2">
												<input name="type" type="radio" id="radio_1" data-value="Half" class="duration" value="Half Day" @if($leave->leave_type =='Half Day') checked="" @endif>
												<label for="radio_1">Hourly</label>
											</div>
											<div class="mr-2">
												<input name="type" type="radio" id="radio_2" data-value="Full" class="type" value="Full Day" @if($leave->leave_type =='Full Day') checked="" @endif>
												<label for="radio_2">Full Day</label>
											</div>
											<div>
												<input name="type" type="radio" class="with-gap duration" id="radio_3" data-value="More" value="More than One day" @if($leave->leave_type =='More than One day') checked="" @endif>
	                            ...
	                            <div class="form-group">
	                            	<div class="col-md-12">
	                                	...
	                                	<input type="date" name="startdate" class="form-control" id="recipient-name1" value="{{$leave->start_date}}">
	                                </div>
	                            </div>
	                            <div class="form-group" id="enddate">
	                            	<div class="col-md-12">
	                                <label class="control-label">End Date</label>
	                                <input type="date" name="enddate" class="form-control" id="recipient-name1" value="{{$leave->end_date}}">
	                               	</div>
	                            </div>
	                            ...
	                            <div class="form-group" id="hourAmount">
	                                ...
	                                <select id="hourAmountVal" class=" form-control custom-select" name="hourAmount" >
	                                    ...
	                                    <option value="1"  @if($leave->leave_duration == 1) selected @endif>One hour</option>
	                                    <option value="2" @if($leave->leave_duration == 2) selected @endif>Two hour</option>
	                                    <option value="3" @if($leave->leave_duration == 3) selected @endif>Three hour</option>
	                                    <option value="4" @if($leave->leave_duration == 4) selected @endif>Four hour</option>
	                                    <option value="5" @if($leave->leave_duration == 5) selected @endif>Five hour</option>
	                                    <option value="6" @if($leave->leave_duration == 6) selected @endif>Six hour</option>
	                                    <option value="7" @if($leave->leave_duration == 7) selected @endif>Seven hour</option>
	                                    <option value="8" @if($leave->leave_duration == 8) selected @endif>Eight hour</option>
	                                </select>
	                            	</div>
	                            </div>						
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<textarea name="leave_message" id="leave_message" class="form-control {{ $errors->has('leave_message') ? ' is-invalid' : '' }}" rows="4">{{ $leave->leave_message }}</textarea>
    ...
    <script>
	    $(document).ready(function () {
	        $('.fetchLeaveTotal').on('click', function (e) {
	            ...
	            var selectedEmployeeID = $(this).data('empid'); //$('.selectedEmployeeID').val();
