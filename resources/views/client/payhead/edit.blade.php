						...
						<form class="form-horizontal" method="POST" action="{{ route('pay-head.update', $payhead->id) }}">
							...
							<div class="card-body">								
								<div class="form-group">
									...
									<div class="col-md-12">
										<input id="name" type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $payhead->name }}">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<select class="form-control" id="pay_type" name="pay_type">
											<option @if($payhead->pay_type == "earnings") selected @endif value="earnings">Earnings</option>
											<option @if($payhead->pay_type == "deductions") selected @endif value="deductions">Deductions</option>
											<option @if($payhead->pay_type == "nothing") selected @endif value="nothing">Blank</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input id="description" type="text" class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ $payhead->description }}">
