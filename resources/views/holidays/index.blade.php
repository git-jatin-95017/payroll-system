...
<div>
    <div class="page-heading d-flex justify-content-between align-items-center gap-3 mb-3">
		<div>
			<h3>Holidays</h3>
			<p class="mb-0">Track and manage your holidays here</p>
		</div>
    </div>
    <div class="d-flex gap-3 align-items-center justify-content-between mb-4">
        <form method="GET" action="{{ route('holidays.index') }}" class="d-flex gap-3 align-items-center justify-content-between mb-4">
   ...
   <div class="bg-white p-4">
        ...
        {{ $holidays->links('vendor.pagination.custom') }}
   </div>
</div>
@endsection
